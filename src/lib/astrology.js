...
const insightsByArea = {
  love: {
    ...
    previewText:
      "Your cosmic configuration reveals a period of deep introspection in your love life. The current planetary energies invite you to re-examine your expectations and communicate more openly with your partner. A deeper emotional connection is possible if you allow yourself to be vulnerable. It's time to let go of old barriers that may have hindered your past relationships.",
  },
  career: {
    keywords: [
      "Opportunity",
  ...
  personal: {
    ...
    previewText:
      "The current cosmic configurations signal a significant period of personal development. Your intuition is particularly sharp, allowing you to access deep inner wisdom. This is the ideal time to re-examine your core values and beliefs. An inner transformation process invites you to align more closely with your authentic self. Stay open to synchronicities that will guide you to your next stage of evolution.",
  },
  family: {
    keywords: [
      "Harmony",
...
export async function getAstrologyPreview(userData) {
  ...
  const areaInsights = insightsByArea[userData.interestArea] || {
    ...
    previewText:
      "The current planetary configurations indicate an important period of growth and development in your life. Your sensitivity to cosmic energies is heightened, allowing you to better perceive the opportunities that present themselves to you. Stay attentive to subtle signs that guide you towards your true path.",
  };
  ...
  if (ascendant) {
    previewText += ` With your ${ascendant.name} ${ascendant.emoji} ascendant, you approach these influences with ${
      ...
      ascendant.name === "Sagittarius"
        ...
        : ascendant.name === "Taurus" ||
            ascendant.name === "Virgo" ||
            ascendant.name === "Capricorn"
...
export async function getFullAstrologyReport(userData) {
  ...
  const areaInsights =
    insightsByArea[userData.interestArea] || insightsByArea.personal;
  ...
  return {
    ...
    overview: [
      ...
      ascendant
        ? `Your ${ascendant.name} ascendant colors your personal expression and influences how others initially perceive you.`
        : "",
      userData.birthLocation
        ? `The influence of ${userData.birthLocation}, your birthplace, manifests in your natural affinity with certain environments and cultures.`
        : "",
      ...
      "The current position of Jupiter in relation to your natal sign amplifies your ability to attract favorable opportunities, particularly in areas related to " +
        (userData.interestArea === "love"
          ? "love and relationships"
          : userData.interestArea === "career"
            ? "career and finances"
            : userData.interestArea === "health"
              ? "health and wellness"
              : userData.interestArea === "family"
                ? "family and home"
                : "personal growth") +
        ".",
    ].filter((text) => text !== ""),
    planets: [
      {
        ...
        interpretation:
          "Your Sun in " +
          sign.name +
          " reveals your essence and fundamental expression in the world. In this position, you naturally radiate with " +
          (sign.name === "Aries" ||
          sign.name === "Leo" ||
          sign.name === "Sagittarius"
            ? "a dynamic and enterprising energy"
            : sign.name === "Taurus" ||
                sign.name === "Virgo" ||
                sign.name === "Capricorn"
              ? "a practical and determined approach"
      ...
      },
      {
        ...
        interpretation:
          "Your Moon in " +
          (ascendant ? ascendant.name : sign.name) +
          " reveals your inner emotional landscape and your deep needs to feel secure.",
      },
    ],
  };
}
