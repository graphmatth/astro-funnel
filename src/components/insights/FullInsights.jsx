              ...
              {report.planets?.map((planet) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-1">
                    <span className="font-medium">Position:</span> {planet.sign} ({planet.degree}°)
                  </p>
              ...
              {report.aspects?.map((aspect, idx) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-1">
                    ...
                    {aspect.influence === 'strong' ? 'Strong' : 
                     aspect.influence === 'moderate' ? 'Moderate' : 'Weak'})
                  </p>
                ...
                <div key={idx} className="border-b pb-4 last:border-0">
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <div className="text-sm text-gray-600">
                      {period.intensity <= 2 ? 'Low Energy' : 
                       period.intensity <= 3 ? 'Moderate Energy' : 'High Energy'}
                    </div>
                  </div>
